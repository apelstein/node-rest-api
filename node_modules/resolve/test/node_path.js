...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/products.js'), 'aaa resolves');
    });
    ...
    resolve('bbb', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/products.js'), 'bbb resolves');
    });
    ...
    resolve('ccc', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/products.js'), 'ccc resolves');
    });
