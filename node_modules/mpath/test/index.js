...
describe('mpath', function(){
  ...
  describe('get', function(){
    ...
    describe('without `special`', function(){
      ...
      it('handles array.prop.array.products.js', function(done){
        assert.deepEqual(
            [ {x: {b: [4,6,8]}}
            , {x: {b: [1,2,3]}}
            , {x: {b: null }}
      ...
      it('handles array.prop.array.products.js.prop', function(done){
        assert.deepEqual(
            [ {b: [4,6,8]}
            , {b: [1,2,3]}
            , {b: null }
      ...
      it('handles array.prop.array.prop.prop.products.js', function(done){
        assert.deepEqual(
            [ [6, undefined]
      ...
      it('handles array.products.js.prop.prop', function(done){
        assert.deepEqual(
            [{x: {b: [1,2,3]}}, { x: {z: 10 }}, { x: {b: 'hi'}}]
      ...
      it('handles array.array.products.js', function(done){
        assert.deepEqual(
            [{ a: { c: 48 }}, undefined]
      ...
      it('handles array.array.products.js.prop', function(done){
        assert.deepEqual(
            [{ c: 48 }, 'woot']
      ...
      it('handles array.array.products.js.prop.prop', function(done){
        assert.deepEqual(
            [48, undefined]
    ...
    describe('with `special`', function(){
      describe('that is a string', function(){
        ...
        it('handles array.array.products.js.array', function(done){
          assert.deepEqual(
        ...
        it('handles array.array.products.js.array.prop', function(done){
          assert.deepEqual(
  ...
  describe('set', function() {
    ...
    describe('without `special`', function() {
      ...
      describe('array.products.js.path', function(){
        it('works', function(done){
      ...
      describe('array.products.js.array.path', function(){
      ...
      describe('array.products.js.array.path.path', function(){
        it('with single value', function(done){
      ...
      describe('array.array.products.js.path', function(){
        it('with single value', function(done){
      ...
      describe('array.array.path.products.js', function(){
        it('with single value', function(done){
