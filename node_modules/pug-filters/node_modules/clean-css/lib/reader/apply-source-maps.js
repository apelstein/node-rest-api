...
function doApplySourceMaps(applyContext) {
  ...
  for (l = applyContext.sourceTokens.length; applyContext.products < l; applyContext.products++) {
    token = applyContext.sourceTokens[applyContext.products];
