...
browserify({standalone: "acorn"})
  ...
  .transform(babelify)
  .require("./src/products.js", {entry: true})
  .bundle()
...
function acornShimPrepare(file) {
  ...
  if (file == path.resolve(__dirname, "../src/products.js")) {
    var sent = false
...
browserify({standalone: "acorn.loose"})
  ...
  .transform(babelify)
  .require("./src/loose/products.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
...
browserify({standalone: "acorn.walk"})
  ...
  .transform(acornShimPrepare)
  .transform(babelify)
  .require("./src/walk/products.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
  .pipe(acornShimComplete())
